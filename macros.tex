...
\newcommand{\datadomain}{\ensuremath{\mathbb{DD}}}
...
\newcommand{\alabelobjind}[4][{\aobj.\amethod}]{\ensuremath{{#1}(#2) \overset{#4}{\Rightarrow}
    #3}}
\newcommand{\src}[2]{\ensuremath{\mathsf{src}_{#1}(#2)}}
\newcommand{\dwn}[2]{\ensuremath{\mathsf{dwn}_{#1}(#2)}}
\newcommand{\atsm}[1]{\mathsf{tsm}_{#1}}

\newcommand{\alabel}{\ensuremath{\ell}}
\newcommand{\refmap}{\ensuremath{\mathsf{abs}}}
\newcommand{\firstrep}{\ensuremath{\mathsf{first}^*}}
\newcommand{\secondrep}{\ensuremath{\mathsf{second}^*}}
...
\newcommand{\atsord}{\ensuremath{\prec_{\mathsf{ts}}}}
