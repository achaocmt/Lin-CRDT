...
%%%%%%%%%%%%% CRDTs %%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\crdtlin}{{\color{magenta} crdt-linearizability}}
\newcommand{\crdtlinearization}{{\color{magenta} crdt-linearization}}
\newcommand{\crdtlinearizable}{{\color{magenta} crdt-linearizable}}
\newcommand{\CRDTLin}{{\color{magenta} CRDT-Linearizability}}
...
\newcommand{\abstate}{\ensuremath{\alpha}}
\newcommand{\abstates}{\ensuremath{\Sigma_{\alpha}}}
...
\newcommand{\absopsemplain}{\ensuremath{\delta}}
...
\newcommand{\Updates}{\ensuremath{\mathsf{Update}}}
\newcommand{\Queries}{\ensuremath{\mathsf{Query}}}

\newcommand{\effector}{\ensuremath{\delta}}
\newcommand{\semop}[2][\aop]{\ensuremath{\llbracket #1
    \rrbracket}\ifthenelse{\isempty{#2}}{}{(#2)}}
\newcommand{\localstates}{\ensuremath{\mathsf{LS}}}
\newcommand{\globalstates}{\ensuremath{\mathsf{GS}}}
