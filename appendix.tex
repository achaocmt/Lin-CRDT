...
\item[-] From $\igconfres(s)$, we generate a abstract state $\gconfres'(s)$. Latter we will prove that $\gconfres'(s)$ satisfies the requirement of $\gconfres$.
