...
$fact1$: Assume $\alinord = \alabel''_1 \cdot \ldots \cdot \alabel''_n$, and for each $i$, the ``virtual message'' of $\alabel''_i$ is $(\alabel''_i,(P''_i,N''_i))$. Assume that $(P,N)$ is obtained from the initial replica state by merging $(P''_1,N''_1),\ldots,(P''_n,N''_n)$. Then, for each replica $\arep$, $P[\arep]$ =  $\vert \{ \alabel \vert \alabel = \alabelshort[{\tt inc}]{}, \alabel$ happens on replica $\arep$, and $\alabel \in \{ \alabel''_1,\ldots,\alabel''_n \} \} \vert$, $N[\arep]$ =  $\vert \{ \alabel \vert \alabel = \alabelshort[{\tt dec}]{}, \alabel$ happens on replica $\arep$, and $\alabel \in \{ \alabel''_1,\ldots,\alabel''_n \} \} \vert$.
...
\noindent $fact2$: Assume $\alinord = \alabel''_1 \cdot \ldots \cdot \alabel''_n$, and for each $i$, the ``virtual message'' of $\alabel''_i$ is $(\alabel''_i,S''_i)$. Assume that $S$ is obtained from the initial replica state by applying effectors $S''_1,\ldots,S''_n$. Then, $S = \{ (a,V) \vert \exists i, 1 \leq i \leq n, \alabel''_i$ generates the ``virtual message'' $(\alabel''_i,(a,V)),\alabel''_i$ is maximal w.r.t the visibility relation among $ \{ \alabel''_1,\ldots,\alabel''_n \} \}$. 
