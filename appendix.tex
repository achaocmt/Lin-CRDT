...
According to the definition of T-tree, we can see that in the major-node-tree $(N,parent)$ of $tree$, 
...
each node can reach $node_0$ by several times of $parent$ relation, and the $parent$ relation is obviously acyclic.
