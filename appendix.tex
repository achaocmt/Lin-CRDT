...
\item[-] For each T-character $w=(a,tid) \in T$, assume $tid = c_1 \cdot \ldots \cdot c_n \cdot (p,id)$. Then,for each $1 \leq i \leq n$,
...
Given a legal tree of tree-doc, we the order $<_t$ is defined as follows: $tid_1 <_t tid_2$, if 
