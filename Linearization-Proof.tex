...
\item[-] If $\alabel = \alabellongNoret[\mathit{remove}]{\argv}$: Let $S' = \{ \alabel' = \alabellongNoret[\mathit{add}]{\argv} \vert (\alabel',\alabel) \in \avisord, \neg \exists \alabel'' = \alabellongNoret[\mathit{remove}]{\argv}, (\alabel',\alabel''), (\alabel'',\alabel) \in \avisord \}$. Then, the downstream content of $\alabel$ is the set of downstream content of operations in $S'$. 
\end{itemize}
\end{example}
