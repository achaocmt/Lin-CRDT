...
% \figurename~\ref{fig:a distributed linearizable history} is a history
...
% The history of \figurename~\ref{fig:a distributed linearizable
...
% \figurename~\ref{fig:a non-distributed linearizable history} is a
