...
\begin{itemize}
\setlength{\itemsep}{0.5pt}
\item[-] $\{ \mathit{state} = (a_1,\mathit{id}_1,f_1) \cdot \ldots \cdot (a_n,\mathit{id}_n,f_n) \wedge l \leq n \wedge b \notin \{ a_1, \ldots, a_n \} \wedge \mathit{id}_l \in S_1 \}$ $(add(b,a_l),\mathit{id},S_1)$ $\{ \mathit{state} = (a_1,\mathit{id}_1,f_1) \cdot \ldots \cdot (a_l,\mathit{id}_l,f_l) \cdot (b,\mathit{id},\mathit{true}) \cdot (a_{l+1},\mathit{id}_{l+1},f_{l+1}) \cdot \ldots \cdot (a_n,\mathit{id}_n,f_n) \}$.
\item[-] $\{ \mathit{state} = (a_1,\_,f_1) \cdot \ldots \cdot (a_n,\_,f_n) \wedge S = \{ a \vert (a,\_,\mathit{true}) \in \mathit{state} \} \wedge l = a_1 \cdot \ldots \cdot a_n \uparrow_{S} \}$ $(read() \Rightarrow l)$ $\{ \mathit{state} = (a_1,\_,f_1) \cdot \ldots \cdot (a_n,\_,f_n) \}$.
\end{itemize} 
