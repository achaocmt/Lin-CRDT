...
To get rid of such problem, we require a condition called causal-timestamp. Intuitively, causal-timestamp requires multiple object to ``share timestamp''. Formally, a history $\ahis$ satisfies causal-time-stamp, if for operations $\aop_1,\aop'_1,\ldots,\aop_k,\aop'_k$ of $\ahis$ satisfies the following condition, we have that the timestamp of $\aop'_1$ is less than that of $\aop_1$: 
...
\subsection{Modified Semantics for Multiple Objects}
\label{subsec:modified semantics for multiple objects} 
