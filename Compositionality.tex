...
\gpnote[nomargin, inline]{Perhaps I would talk about interleavings.}
...
\gpwarning{I would perhaps conclude the section stating some common composition of objects that are CRDTlin{} by our results.}
...
\hline
LWW-register~\cite{?}&\tonelin&$\alabelshort[{\tt write}]{value}$, $\alabellong[{\tt read}]{}{value}{}$\\
\hline
Multi-value register~\cite{?}&\tzerolin&$\alabelshort[{\tt write}]{value}$, $\alabellong[{\tt read}]{}{Set \ value}{}$\\
\hline
...
\hline
RGA~\cite{?}&\tonelin&$\alabelshort[{\tt addAfter}]{value,value}$, $\alabelshort[{\tt remove}]{value}$,
                \\ & & $\alabellong[{\tt read}]{}{List \ value}{}$\\
\hline
Wooki~\cite{?}&\tzerolin&$\alabelshort[{\tt addBetween}]{value,value,value}$, $\alabelshort[{\tt remove}]{value}$,
                \\ & & $\alabellong[{\tt read}]{}{List \ value}{}$\\
\hline
Tree-Doc~\cite{?}&\tzerolin&$\alabelshort[{\tt addBetween}]{value,value,value}$, $\alabelshort[{\tt remove}]{value}$,
                \\ & & $\alabellong[{\tt read}]{}{List \ value}{}$\\
\hline
\end{tabular}
