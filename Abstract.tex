...
%
  These systems must accept updates at any replica and propagate these updates asynchronously to every other replica.
%
...
%  akin to Linearizability as defined by~\citet{HerlihyW90}.
  ...
  %
  We provide a proof methodology to show that a CRDT satisfies replication-aware linearizability
