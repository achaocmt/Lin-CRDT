...
This transition first applies the \lstinline|atSource| function $\atsource$
in the state of the origin replica, and as a result it outputs a
...
function $\atsource$) in an identity effector $\effector$ (i.e.
...
with object compositions (see \autoref{sec:compositionality}).
